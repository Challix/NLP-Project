...
train_dataset = TerDataset(train_encodings, train_labels)
val_dataset = TerDataset(val_encodings, val_labels)
...
finetune_params = ['module.pre_classifier.bias', 'module.classifier.bias', 'module.pre_classifier.weight', 'module.classifier.weight']
