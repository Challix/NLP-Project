...
# text_model = DistilBertForSequenceClassification.from_pretrained("results_ter/checkpoint-184", output_hidden_states=True)
# audio_model = Wav2Vec2ForSequenceClassification.from_pretrained("results_ser/checkpoint-14605", output_hidden_states=True)
...
checkpoint_path = 'results_attn_feat_fusion/attn_feat_fusion_02.pth'
